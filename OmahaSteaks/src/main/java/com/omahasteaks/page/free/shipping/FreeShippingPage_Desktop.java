...
public class FreeShippingPage_Desktop extends GeneralPage_Desktop implements FreeShippingPage {
	// ================================================================================
	// Locators
	// ================================================================================
	...
	public void addFirstSkuToCart(boolean doAddExclusiveOffer) {
		Common.waitForPageLoad();
		Common.waitForDisplayed(eleFirstSku);
		ComboBox cbbSelectShipTo = getCbbSelectShipTo(eleFirstSku);
		TextBox txtShipTo = getTxtShipTo(eleFirstSku);
