...
public class ExtentManager {
	...
	public synchronized static ExtentReports getReporter(String outputResult) throws Exception {
		if (extent == null) {
			String outPutFolder = System.getProperty("user.dir") + System.getProperty("file.separator") + "test-output";
			...
			File output = new File(System.getProperty("user.dir") + System.getProperty("file.separator")
					+ path[path.length - 3] + System.getProperty("file.separator") + path[path.length - 2]);
			output.mkdir();
			// }
