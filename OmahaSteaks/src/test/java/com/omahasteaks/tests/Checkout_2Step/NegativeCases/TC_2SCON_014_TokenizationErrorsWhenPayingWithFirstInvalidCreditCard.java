...
public class TC_2SCON_014_TokenizationErrorsWhenPayingWithFirstInvalidCreditCard extends TestBase_2SC {
    ...
    @Test
    public void TC_2SCON_014_Tokenization_Errors_When_Paying_With_First_Invalid_Credit_Card() {
	initTestCaseData();
	...
	Logger.info("- Enter an incomplete CC number (fewer than 16 digits) starting with 4 in the first CARD NUMBER text field.  For example, " + Constants.CREDIT_CARD_NUMBER_FEWER_THAN_16_DIGITS + ".\n" + "- Enter valid data in CARD EXPIRATION text field.\n" + "- Enter valid data in first Amount textbox\n" + "- Click PLACE ORDER button.");
	...
	Logger.info("In Payment and Review Page:\n" + "- Enter invalid number (for example, " + Constants.INVALID_CREDIT_CARD_NUMBER + ") in the first CARD NUMBER text field.\n" + "- Enter valid data in CARD EXPIRATION text field.\n" + "- Click PLACE ORDER button.");
	...
	Logger.tc("TC_2SCON_014 - Tokenization Errors When Paying With First Credit Card");
	Logger.to("TO_2SCON_41 - Two Credit Card - Tokenization errors when paying with first Credit Card number (fewer than 16 digits)\n");
	Logger.to("TO_2SCON_42 - Two Credit Card - Tokenization errors when editing first Credit Card number");
