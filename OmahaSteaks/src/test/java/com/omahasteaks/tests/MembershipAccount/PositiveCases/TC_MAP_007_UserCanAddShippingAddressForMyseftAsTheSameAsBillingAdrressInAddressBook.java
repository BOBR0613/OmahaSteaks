...
public class TC_MAP_007_UserCanAddShippingAddressForMyseftAsTheSameAsBillingAdrressInAddressBook extends TestBase_2SC {
	...
	@Test
	public void TC_MAP_007_User_Can_Add_Shipping_Address_For_Myseft_As_The_Same_As_Billing_Adrress_In_Address_Book() {
		...
		verifyShippingAddressDisplaysAsTheSameAsBillingAddressInMyAccountPage();
	...
	// Test Case Methods
	// ================================================================================
	private void verifyShippingAddressDisplaysAsTheSameAsBillingAddressInMyAccountPage() {
	...
	private void fillShippingAddressAndClickUpdate() {
		...
		shippingAddress.updateFieldValueBy(AddressFields.FIRST_NAME, billingAddress.firstName);
		shippingAddress.updateFieldValueBy(AddressFields.LAST_NAME, billingAddress.lastName);
	...
	private void initTestCaseData() {
		Logger.tc("TC_MAP_007 - User can add Shipping Address for Myself as the same as Billing Address in Address Book");
		Logger.to("TO_MAP_15 - User can add the shipping address for Myself as the same as the billing address in Address Book");
