...
public class TC_MAN_006_WarningMessageDisplaysWhenEditingShippingAddressWithInvalidData extends TestBase_2SC {
	...
	@Test
	public void TC_MAN_006_Warning_Message_Displays_When_Editing_Shipping_Address_With_Invalid_Data() {
	...
	private void fillInvalidZipCodeStateCityStreetAndVerifyWarningMessage(AddressFields field, String valueUpdate, String expectedMessage) {
		...
		assertEquals(myAccountPage.getAddressWarningMessage(), expectedMessage, "Warning message \" " + expectedMessage + " \" is not  displayed");
	}
	...
	private void initTestCaseData() {
		Logger.tc("TC_MAN_006 -Warning message displays for invalid data for address fields in Edit Shipping address page");
		Logger.to("TO_MAN_37 - Warning message \"State does not match USPS database (California)\" is displayed when filling State does not match Zip Code, City, Address1, Country in Edit Shipping address page for Myself (e.g. State: New York, ZipCode: 95129, City: San Jose, Country: United State, Address1: 5273 Prospect Rd)");
		Logger.to("TO_MAN_38 - Warning message \"City does not match USPS database (Schenectady)\" is displayed when filling City does not match Zip Code, State, Address1, Country in Edit Shipping address page for Myself (e.g. State: California, ZipCode: 95129, City:Schenectady, Country: United State, Address1: 5273 Prospect Rd)");
		Logger.to("TO_MAN_39 - Warning message \"Invalid city/state/zip information\" is displayed when filling Zip Code does not match City, State, Address1, Country in Edit Shipping address page for Myself (e.g. State: California, ZipCode: 12345, City: San Jose, Country: United State, Address1: 5273 Prospect Rd)");
		Logger.to("TO_MAN_40 - Warning message \"Address not found on street\" is displayed when filling Address1 does not match ZipCode, City, State, Country in Edit Shipping address page for Myself (e.g. State: California, ZipCode: 95129, City: San Jose, Country: United State, Address1: 105 Jay Street)");
		Logger.to("TO_MAN_41 - Warning message \"Street name not found\" is displayed when filling invalid address into Address1 field in Edit Shipping address page for Myself (e.g. State: California, ZipCode: 95129, City: San Jose, Country: United State, Address1:Prospect Rd)");
		Logger.to("TO_MAN_42 - Warning message \"Insufficient address information\" is displayed when filling invalid value into Address1 field in Edit Shipping address page for Myself (e.g. State: California, ZipCode: 95129, City: San Jose, Country: United State, Address1:12345abcdef)");
