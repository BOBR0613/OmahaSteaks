...
public class TC_SOP_004_UserCanCompleteCheckoutWithCustomDeliveryDate extends TestBase_2SC {
    ...
    @Test
    public void TC_SOP_004_User_Can_Complete_Checkout_With_Custom_Delivery_Date() {
	initTestCaseData();
	...
	Logger.tc("TC_SOP_004 - User Can Complete Checkout With Custom Delivery Date");
	Logger.to("TO_SOP_21 - In Payment & Review page, user can click 'View All Shipping Options' link and select Shipping Method \"Custom Delivery Date\" on the 'Shipping & Delivery' modal then complete checkout");
	myAddress = lstAddresses.getDefaultShippingAddress();
	myItem.initRandom(Recipient.MYSELF);
	myShippingMethod = Constants.CUSTOM_SHIPPING;
    }
